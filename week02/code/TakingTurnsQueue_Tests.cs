...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue returned people in the wrong order because PersonQueue added new people to the front instead of the back.
    ...
    // Defect(s) Found:  None. The test passed because the correct InvalidOperationException was thrown with the expected message.
